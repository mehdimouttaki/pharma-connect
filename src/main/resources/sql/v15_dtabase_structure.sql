...
-- Listage de la structure de la table pharma_connect. city
...
-- Listage des données de la table pharma_connect.city : ~393 rows (environ)
...
-- Listage des données de la table pharma_connect.delivery_man : ~1 rows (environ)
...
-- Listage des données de la table pharma_connect.pharmacy : ~5 rows (environ)
...
-- Listage des données de la table pharma_connect.product : ~9 rows (environ)
...
-- Listage des données de la table pharma_connect.user : ~2 rows (environ)
...
(71, 'omaranjar@gmail.com', '$2a$10$R5AGmRFmYtqvbGUT8/BmgO5N7ltnDG123wKqWm3R74bocynujM6SK', 'DELIVERY', 'omar', 'nejar', '2021-02-12 10:33:02', 'ACTIVE');
