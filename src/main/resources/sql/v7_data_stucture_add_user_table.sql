...
-- Dumping structure for table pharam_connect.admin
...
-- Dumping structure for table pharam_connect.chat
...
-- Dumping structure for table pharam_connect.client
...
-- Dumping structure for table pharam_connect.delivery_man
...
-- Dumping structure for table pharam_connect.detail_order
...
-- Dumping structure for table pharam_connect.historical_address
...
-- Dumping structure for table pharam_connect.lk_pharmacy_permanent
...
-- Dumping structure for table pharam_connect.orders
...
-- Dumping structure for table pharam_connect.payment
...
-- Dumping structure for table pharam_connect.permanent
...
-- Dumping structure for table pharam_connect.pharmacy
...
-- Dumping structure for table pharam_connect.product
...
-- Dumping structure for table pharam_connect.review
...
-- Dumping structure for table pharam_connect.user
